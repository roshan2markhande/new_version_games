...
(function(global,$){
	...
	global.getPageName = function(href) {
		...
		if (href.match(/^https?:\/\//i)) {
			...
			var page_name = href.replace(/^[^#?]*\/([\w0-9\-_]+\.html)/i,"$1");
			return page_name;
		}
	};
	...
	global.runPageUnloadHandlers = function() {
		while (unload_handlers.length) { (unload_handlers.shift())(); }
	};
